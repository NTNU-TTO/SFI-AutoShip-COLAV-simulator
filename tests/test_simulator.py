...
from colav_simulator.visualization.animation import visualize
...
def main():
    ...
    (
        ...
        show_waypoints,
        evaluate_results,
        radius_preferred_cpa,
        radius_minimum_acceptable_cpa,
        radius_near_miss_encounter,
        radius_collision,
        radius_colregs_2_max,
        radius_colregs_3_max,
        radius_colregs_4_max,
    ) = read_config()
